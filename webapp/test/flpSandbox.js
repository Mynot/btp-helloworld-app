		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World App Title 2",
									"targetURL": "#sapbtphelloworldui52-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphelloworldui52-display": {
								"semanticObject": "sapbtphelloworldui52",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.helloworldui52",
									"url": sap.ui.require.toUrl("sap/btp/helloworldui52")
								}
							}
						}
					}
